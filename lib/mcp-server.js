 ...
 *
 * Initializes the SyncEngine for the target project (optionally using --project-path),
 * registers MCP tools and resources that expose sync operations and project information,
 * and connects the MCP server via a stdio transport so it begins serving requests.
 */
