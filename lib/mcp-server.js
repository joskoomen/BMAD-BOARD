...
/**
 * Extracts the `--project-path` command-line option and returns parsed values.
 * @param {string[]} argv - The process arguments array (e.g., `process.argv`).
 * @returns {{projectPath?: string}} An object that includes `projectPath` as an absolute path when `--project-path <value>` is present; the property is omitted otherwise.
 */
